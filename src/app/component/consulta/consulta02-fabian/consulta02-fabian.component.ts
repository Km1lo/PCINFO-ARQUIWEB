...
@Component({
  selector: 'app-consulta02-fabian',
  templateUrl: './consulta02-fabian.component.html',
  styleUrls: ['./consulta02-fabian.component.css']
})
export class Consulta02FabianComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.rS.getCuestionario2EstadoByUsuario().subscribe(data => {
      this.dataSource = new MatTableDataSource(data);
    })
  }
  getCuestionario2EstadoByUsuario(): void {
    this.rS.getCuestionario2EstadoByUsuario()
